...
public class TeleAlign implements Command {
    ...
    public TeleAlign(CrabRobot robot, SimpleMecanumDrive drive, double align_power, boolean alignLeft, Telemetry telemetry){
        this.robot = robot;
